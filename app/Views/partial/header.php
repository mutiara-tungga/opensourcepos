...
<head>
    ...
    <?php if (ENVIRONMENT == 'development' || get_cookie('debug') == 'true' || $request->getGet('debug') == 'true') : ?>
        ...
        <link rel="stylesheet" href="resources/css/invoice-665a47468b.css">
        <link rel="stylesheet" href="resources/css/ospos_print-f4fb584c1f.css">
        ...
        <link rel="stylesheet" href="resources/css/receipt-fbfdb9e8d5.css">
    ...
    <?php else : ?>
        <!--inject:prod:css -->
        <link rel="stylesheet" href="resources/opensourcepos-663d1b2725.min.css">
        <!-- endinject -->
        ...
        <script src="resources/opensourcepos-887816d5a6.min.js"></script>
        <!-- endinject -->
    <?php endif; ?>
